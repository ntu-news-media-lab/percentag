...
class Recommend extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  componentDidMount() {
    ...
    if (Array.isArray(newThis.state.savedTags) && newThis.state.savedTags.length) {
      this.setState({
        recommended: [{
          title: ""
        }]
    ...
    console.log("current saved tags to get recommendation" + this.state.recommended);
  }
...
//# sourceMappingURL=app.c5a463e7967c06bdbe95.hot-update.js.map