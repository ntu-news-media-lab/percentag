...
class ApiCall extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    ...
    this.callApi = async () => {
      const response = await fetch('http://localhost:5000/api/scrap', {
        ...
        body: JSON.stringify({
          url: "https://www.dealstreetasia.com/stories/aiot-startup-aiforward-77m-232438/"
        })
      });
  ...
  getCurrentURL() {
    ...
    console.log("state has correct url"); // chrome.tabs.onActivated.addListener((activeInfo) => {  
...
//# sourceMappingURL=app.106a47cc7643c135ea41.hot-update.js.map