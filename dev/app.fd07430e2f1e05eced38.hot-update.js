...
class ApiCall extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    ...
    this.state = {
      ...
      post: '',
      responseToPost: '',
      currentURL: 'https://www.dealstreetasia.com/stories/payfazz-xfers-fazz-financial-group-230319/'
    };
  ...
  componentDidMount() {
    this.getCurrentURL().then(url => this.getTagApi(url)); // this.getTagApi()
  }
...
//# sourceMappingURL=app.fd07430e2f1e05eced38.hot-update.js.map