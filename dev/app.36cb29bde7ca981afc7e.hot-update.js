...
class App extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  componentDidMount() {
    chrome.storage.local.get(['tags'], function (result) {
      console.log("User is " + result.tags); // you can use the variable or set to any state variable from here
    });
  }
...
//# sourceMappingURL=app.36cb29bde7ca981afc7e.hot-update.js.map