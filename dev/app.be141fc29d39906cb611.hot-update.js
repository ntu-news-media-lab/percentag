...
class Tags extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  componentDidMount() {
    this.setState({
      savedTags: this.props.savedTags
    });
    console.log("SavedTags in tags.js" + this.state.savedTags); // this.getChromeStoragefunction(this.state.savedTags);
  }
...
//# sourceMappingURL=app.be141fc29d39906cb611.hot-update.js.map