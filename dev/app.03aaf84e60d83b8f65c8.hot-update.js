...
class Tags extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  getChromeStoragefunction() {
    let tempArray = [...this.state.savedTags]; // chrome.storage.sync.get({ tags: [] }, function (result) {
    //   var tags = result.tag;
    ...
    //     // })
    //   } else {
    //     // result.tags.map(e => {tempArray.push(e); })
    //     result.tags.map(e => {console.log("test" + e); })
    //     // this.setState({
    //     //     savedTags: tempArray
    //     // })
    //   }
...
//# sourceMappingURL=app.03aaf84e60d83b8f65c8.hot-update.js.map