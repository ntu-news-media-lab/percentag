...
function removeTag(tagName) {
  ...
  chrome.storage.local.get(['tags'], function (result) {
    ...
    tempArray = tempArray.filter(item => item !== tagName); // console.log("test" + tempArray)

    chrome.storage.local.set({
      tags: tempArray
    }, function () {// console.log("saved: " + tempArray);
    });
  });
...
//# sourceMappingURL=app.3ecb12c778345606df8c.hot-update.js.map