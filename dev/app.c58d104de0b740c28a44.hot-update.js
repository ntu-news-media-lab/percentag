  ...
  chrome.storage.sync.get({
    ...
    if (typeof tags === "undefined") {
      ...
      chrome.storage.sync.set({
        ...
        console.log('Value is set to ' + tempArray);
      });
    }
  });
} // function updateTagArray(tagName) {
//   chrome.storage.sync.get({ tags: [] }, function (result) {
//     result.list.push(tagName);
//     //then call the set to update with modified value
//     chrome.storage.sync.set({ tags: tagArray }, function () {
//       console.log('Value is set to ' + tagArray);
//     });
//   });
// }
...
//# sourceMappingURL=app.c58d104de0b740c28a44.hot-update.js.map