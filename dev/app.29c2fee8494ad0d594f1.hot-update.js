...
class Recommend extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    ...
    this.getRecommendation = async () => {
      ...
      recommendArr.map(async recoObj => {
        ...
        let tempState = [...this.state.resultScore];
        tempState.push(body.express[0]);
        this.setState({
          resultScore: tempState
        });
      });
...
//# sourceMappingURL=app.29c2fee8494ad0d594f1.hot-update.js.map